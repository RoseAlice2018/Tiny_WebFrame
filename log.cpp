...
class NameFormItem:public LogFormatter::FormatItem{
public:
    NameFormItem(const std::string& str = ""){}
    void format(std::ostream& os,Logger::ptr logger,LogLevel::Level level,LogEvent::ptr event)override{
...
void Logger::setFormatter(const std::string &val) {
    ...
    TinyWebFrame::LogFormatter::ptr new_val(new TinyWebFrame::LogFormatter(val));
    if(new_val->isError()){
